#Очень плохо понял реализацию С на питоне. Но получилось реализовать простецкий код на С в отдельном файле
#(простой скрипт си-кода для создания двумерного массива, то есть матрицы)
